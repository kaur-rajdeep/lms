...
export const Info = () => {
  return (
    <Box sx={{ mt: "5%", backgroundColor: "#f6f6f6", py: "2%"}}>
      ...
      <Box sx={{display:{md:'flex', sm:'grid'}, justifyContent:{md:'space-around', sm:'center'}, m:'5%', columnGap:'2%', width:{md:'70%'}}}>
        <Box sx={{backgroundColor:'#d1cdcd', width:{md:'30%', sm:'70%', xs:'90%'}, borderRadius:'50px', p:{sm:'12%', md:'4%', xs:'6%'}, m:{sm:'4%', md:1, xs:2}, display:'flex', placeItems:'center', flexDirection:'column'}}>
            <WorkspacePremiumIcon sx={{width:'80px', height:'80px', color:'#DA3D33', px:'2%'}}/>
            <Typography sx={{ fontWeight:'600'}}>Founded by Panacea
...
cybersecurity firm.</Typography>
        ...
        <Box sx={{backgroundColor:'#d1cdcd', width:{md:'30%', sm:'70%', xs:'90%'}, borderRadius:'50px', p:{sm:'12%', md:'4%', xs:'6%'}, m:{sm:'4%', md:1, xs:2}, display:'flex', placeItems:'center', flexDirection:'column'}}>
            ...
            <Typography sx={{ fontWeight:'600'}}>High practice-to-instruction
ratio for practical skill
development.</Typography>
        </Box>
        <Box sx={{backgroundColor:'#d1cdcd', width:{md:'30%', sm:'70%', xs:'90%'}, borderRadius:'50px', p:{sm:'12%', md:'4%', xs:'6%'}, m:{sm:'4%', md:1, xs:2}, display:'flex', placeItems:'center', flexDirection:'column'}}>
            <SensorOccupiedOutlinedIcon sx={{width:'80px', height:'80px', color:'#DA3D33', px:'2%'}}/>
            <Typography sx={{fontWeight:'600'}}>Receive 1:1 mentorship from
