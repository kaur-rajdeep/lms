...
export const Reviews = () => {
  const [activeIndex, setActiveIndex] = useState(1); // Index state starts at 0
    ...
    >
      ...
      >
        <Typography
          variant="h3"
          sx={{
            fontSize: { xs: "32px", sm: "68px", md: "48px" },
            fontWeight: 600,
            lineHeight: 1.4,
            fontFamily: "Oswald",
          }}
            ...
            return (
              <Card
                ...
                sx={{
                  ...
                  opacity: index === activeIndex ? 1 : 0.8, // Apply opacity for non-active cards
      ...
      <Box sx={{ display: "flex", mt: "-8%", justifyContent: "space-around" }}>
